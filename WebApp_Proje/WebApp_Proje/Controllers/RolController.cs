...
namespace WebApp_Proje.Controllers
{
    ...
    public class RolController : Controller
    {
        ...
        public RolController(WebApp_ProjeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RolId,RolAdi")] Rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RolId,RolAdi")] Rol rol)
        {
            if (id != rol.RolId)
            {
                return NotFound();
